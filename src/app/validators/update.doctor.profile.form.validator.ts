...
export class UpdateDoctorProfileFormValidator extends Validator<UpdateDoctorProfileByIdValidationModel> {
  constructor() {
    super();
  }

  getTranslationData(translate: TranslateService) {
    translate.get('Pages.UpdateDoctorProfile.Form.Controls').subscribe(data => {
